...
public class User {
	...
	@JoinTable(
			name = "users_leaveAllocations",
			joinColumns = @JoinColumn(
					name = "userid",referencedColumnName = "userId"
			),
			inverseJoinColumns = @JoinColumn(
					name = "leaveAllocationId", referencedColumnName = "leaveAllocationId"
			)
	)
	private List<LeaveAllocation> leaveAllocation;

//	@ManyToOne
//	@JoinColumn(name = "leave_application_leave_application_id",referencedColumnName = "user_user_id")
